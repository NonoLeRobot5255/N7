...
% TO DO %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    exitflag = 0;
    while exit == 0
       J_res_beta = J_residu_C14(beta, donnees);
       res_beta = residu_C14(beta, donnees);
       beta = beta -(J_res_beta'*J_res_beta)\(J_res_beta)'*res_beta;
       if gradient((1/2)norm(res_beta)^2) <max(option(2))
           exitflag=1;
       end
       if 
